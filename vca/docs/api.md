...
| `vca.audit.v1` | AuditService | 2 | 0 | The append only audit store of each service with its retention, open to the admin only (ADR-039). |
...
Total: 20 packages, 22 services, 148 RPCs, 4 server streaming RPCs.
