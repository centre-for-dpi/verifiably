...
| `core/fetchguard` | HTTP fetcher with a guard against server side request forgery: scheme, user name, host allowlist and address rules, plus a cache with a time to live and an entity tag. | Internal (ADR-022) |
