...
// Command issued-credentials serves vca.issued.v1.IssuedService
// (ADR-017). Run with -healthcheck to probe /readyz and exit.
package main
...
import (
	...
	"github.com/centre-for-dpi/vc-adapters/services/issued-credentials/internal/serve"
)
...
func run(ctx context.Context, args []string, getenv func(string) string, stdout, stderr io.Writer) int {
	flags := flag.NewFlagSet("issued-credentials", flag.ContinueOnError)
