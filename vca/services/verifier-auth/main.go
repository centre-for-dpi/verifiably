...
// Command verifier-auth logs verifier staff in with OpenID Connect and issues
// ES256 session tokens (ADR-036, on the flow of ADR-012).
package main
...
func run(args []string) int {
	fs := flag.NewFlagSet("verifier-auth", flag.ContinueOnError)
	...
	log.Info("verifier-auth starting", "version", version, "public_url", cfg.PublicBaseURL)
