...
// Command data-source serves vca.datasource.v1.DataSourceService
// (ADR-015). Run with -healthcheck to probe /readyz and exit.
package main
...
import (
	...
	"github.com/centre-for-dpi/vc-adapters/services/data-source/internal/app"
	"github.com/centre-for-dpi/vc-adapters/services/data-source/internal/config"
	"github.com/centre-for-dpi/vc-adapters/services/data-source/internal/serve"
)
...
func run(ctx context.Context, args []string, getenv func(string) string, stdout, stderr io.Writer) int {
	flags := flag.NewFlagSet("data-source", flag.ContinueOnError)
...
func serveOrProbe(ctx context.Context, healthcheck bool, getenv func(string) string, stdout io.Writer) error {
	...
	a, err := app.Build(cfg, app.Deps{Log: log, Getenv: getenv})
	if err != nil {
		return err
	}
