...
// Unimplemented. Inji keeps no tenants to hold a webhook. The capability
// answer lists no FEATURE_WEBHOOKS, so the admin notifications page
// shows no webhook form for this stack (ADR-040 decision 2).
const webhookMessage = "the adapter sets no Inji webhook for a tenant; Inji keeps no tenants"
