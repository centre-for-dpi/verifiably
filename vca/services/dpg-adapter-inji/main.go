...
// Command dpg-adapter-inji serves the vca.backend.v1 services against
// Inji Certify and Inji Verify (ADR-002 decision 2). Run it with
...
func run(ctx context.Context, args []string, getenv func(string) string, stdout, stderr io.Writer) int {
	flags := flag.NewFlagSet("dpg-adapter-inji", flag.ContinueOnError)
