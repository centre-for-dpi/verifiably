...
// Command verifier-results serves vca.results.v1.ResultsService (ADR-025).
...
import (
	...
	"github.com/centre-for-dpi/vc-adapters/services/verifier-results/internal/app"
...
func run(ctx context.Context, args []string, getenv func(string) string, stdout, stderr io.Writer) int {
	flags := flag.NewFlagSet("verifier-results", flag.ContinueOnError)
