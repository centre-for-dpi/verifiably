...
// Command verifier-combined serves vca.combined.v1.CombinedService (ADR-026).
...
import (
	...
	"github.com/centre-for-dpi/vc-adapters/services/verifier-combined/internal/app"
...
func run(ctx context.Context, args []string, getenv func(string) string, stdout, stderr io.Writer) int {
	flags := flag.NewFlagSet("verifier-combined", flag.ContinueOnError)
