...
INSERT INTO certify.credential_config (
    ...
    'VerifiablePersonCredential',
    gen_random_uuid()::VARCHAR(255),
    'active',
    '',
    NULL,
    NULL,
    'https://www.w3.org/2018/credentials/v1',
    'VerifiableCredential,VerifiablePersonCredential',
    'ldp_vc',
    ...
    NULL,
    '[{"name": "Verifiable Person Credential", "locale": "en", "logo": {"url": "https://verifiably.id/static/credential-logo.svg", "alt_text": "Verifiably"}, "background_color": "#0f172a", "text_color": "#FFFFFF", "background_image": {"uri": "https://verifiably.id/static/credential-logo.svg"}}]'::JSONB,
    ARRAY['fullName', 'givenName', 'familyName', 'gender', 'dateOfBirth', 'email', 'phoneNumber'],
    'mock_identity_vc_ldp',
    ARRAY['did:jwk'],
    ARRAY['Ed25519Signature2020'],
    '{"jwt": {"proof_signing_alg_values_supported": ["RS256", "ES256"]}}'::JSONB,
    '{"fullName": {"display": [{"name": "Full Name", "locale": "en"}]}, "givenName": {"display": [{"name": "Given Name", "locale": "en"}]}, "familyName": {"display": [{"name": "Family Name", "locale": "en"}]}, "gender": {"display": [{"name": "Gender", "locale": "en"}]}, "dateOfBirth": {"display": [{"name": "Date of Birth", "locale": "en"}]}, "email": {"display": [{"name": "Email", "locale": "en"}]}, "phoneNumber": {"display": [{"name": "Phone Number", "locale": "en"}]}}'::JSONB,
    NULL,
    NULL,
    ARRAY['revocation'],
    NULL,
