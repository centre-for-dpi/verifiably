...
>
> **See also [`docs/technical-scope.md`](docs/technical-scope.md)** (2026-09-10) — the
> measured baseline (coverage, lint, CI) plus the seven-workstream scope for quality
> gates, cloud-wallet capability, issuance, verification, DeDi cross-border trust,
> PKI/HSM, and finishing K8s. It sequences several items already listed below and
> supersedes their priority ordering where the two differ.
